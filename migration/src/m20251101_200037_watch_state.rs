        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .if_not_exists()
                    .col(string(WatchState::WatchStateId).unique_key().not_null().primary_key())
                    .col(string(WatchState::UserId).not_null())
                    .col(string(WatchState::Source).not_null())
                    .col(string(WatchState::Id).not_null())
